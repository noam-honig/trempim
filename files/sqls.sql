...
insert into shinuim.images (id, image, createdAt, createUser)
select id, image, createdAt, createUser
from ezion.images;

insert into shinuim.session (id, createdAt, ip, headers)
select id, createdAt, ip, headers
from ezion.session;

insert into shinuim.users (id, org, name, phone, adminNotes, createDate, createUserId, admin, dispatcher, trainee, manageDrivers, deleted, lastUpdateView, addressApiResult, address, showAllOrgs, okCategories)
