...
//[ ] - הוספה של פניה עצמית נרשם כאביעד בסביבת הדגמה
//[ ] - להעלות לאויר את הסביבה של גלעד
//[ ] - להוסיף את הלוגו של גלעד
//[ ] - לסדר את הטיוטות עם האחרונה למעלה
//[ ] להוסיף 3 נק במסך הטיוטות לDISPATCHER
//[ ] - לסדר שINTAKE יעבוד גם כאשר SIGNED IN ולא יראה מצחיק כמו עכשיו
